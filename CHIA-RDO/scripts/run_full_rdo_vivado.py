#!/usr/bin/env python3
"""Run post-route characterization for the 4x4 Full-RDO MVP on KV260."""
...
BUILD = ROOT / "build" / "phase5_1" / "vivado"
RESULT = ROOT / "results" / "phase5_1" / "vivado_kv260.json"
...
def main() -> None:
    ...
    command = [
        ...
        "rtl/synth_full_rdo_mvp_kv260.tcl", "-tclargs", str(BUILD),
    ]
    ...
    metrics: dict[str, int | float | bool | None | str] = {}
    ...
    result = {
        "schema_version": "chia-rdo.full-rdo-mvp-vivado-kv260.v1",
        "created_utc": datetime.now(timezone.utc).isoformat().replace("+00:00", "Z"),
        "tool": "Vivado 2024.2",
        "part": "xck26-sfvc784-2LV-c",
        "clock_constraint_ns": 5.0,
        "implementation": "out_of_context_post_route",
        "metrics": metrics,
    }
