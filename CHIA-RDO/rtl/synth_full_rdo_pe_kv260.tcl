...
read_verilog -sv rtl/rdo_pe.sv rtl/full_rdo_codec_4x4.sv rtl/full_rdo_mvp_4x4.sv rtl/full_rdo_pe.sv
read_xdc rtl/constraints/kv260.xdc
synth_design -top full_rdo_pe -part xck26-sfvc784-2LV-c -mode out_of_context
opt_design
place_design
phys_opt_design
route_design
...
write_checkpoint -force $output_dir/full_rdo_pe_routed.dcp
