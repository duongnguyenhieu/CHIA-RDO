...
set pipeline_depth [lindex $argv 1]
set cost_width [lindex $argv 2]
set output_dir [file normalize [lindex $argv 3]]
file mkdir $output_dir

read_verilog -sv rtl/rdo_pe.sv rtl/rdo_array.sv
read_xdc rtl/constraints/kv260.xdc
synth_design -top rdo_array -part xck26-sfvc784-2LV-c -mode out_of_context \
  -generic "P=$parallelism PIPELINE_DEPTH=$pipeline_depth COST_WIDTH=$cost_width MAX_CANDIDATES=35"
opt_design
place_design
phys_opt_design
route_design
...
write_checkpoint -force $output_dir/rdo_array_routed.dcp
...
puts $metrics "pipeline_depth=$pipeline_depth"
puts $metrics "cost_width=$cost_width"
